...
function! s:setupSyntaxHighlighting()
    ...
    if g:NERDChristmasTree
        hi def link treePart SpecialChar
        hi def link treePartFile Tag
        hi def link treeFile Normal
        hi def link treeExecFile Title
        hi def link treeDirSlash SpecialComment
        hi def link treeClosable Tag
    else
    ...
    hi def link treeHelp PreCondit
    hi def link treeHelpKey Keyword
    hi def link treeHelpCommand PreCondit
